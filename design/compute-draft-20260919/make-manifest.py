#!/usr/bin/env python3
"""Build the compute bundle. Base: stage-2 manifest; requires the successful 26.2.3 probe. Output: ~/y700-agent/vkcompute-<hash16>/."""
...
FILES = ['run-compute.py', 'vkcompute.py', 'vkabi.py', 'computelog.py', 'fill.spv', 'fill.spvasm', 'gpuguard.py', 'health_guard.py', 'runtime-readers.py', 'y700lib.py', 'expected-state.txt']
...
out = AGENT/('vkcompute-'+hashlib.sha256(text).hexdigest()[:16])
