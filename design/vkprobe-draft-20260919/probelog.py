...
ORDER = ['READY_FOR_PROBE', 'ICD_LOADED', 'NEGOTIATED', 'INSTANCE_CREATED', 'ENUMERATE_ENTER', 'PHYSICAL_DEVICES', 'PROPERTIES', 'HELD']

class ProbeLog:
    def __init__(self):
        self.stage = 0; self.go_sent = False; self.props = None; self.interface = None; self.mesa = []; self.held = None
    def expect(self, tag):
